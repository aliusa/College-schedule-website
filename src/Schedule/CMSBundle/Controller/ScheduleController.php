...
use Schedule\CMSBundle\Entity\Schedule;
use Schedule\CMSBundle\Form\ScheduleType;
...
class ScheduleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ScheduleCMSBundle:Schedule')->findAll();
     ...
     * @Method("POST")
     * @Template("ScheduleCMSBundle:Schedule:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ScheduleCMSBundle:Schedule')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ScheduleCMSBundle:Schedule:edit.html.twig")
     */
