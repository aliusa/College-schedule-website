...
use Schedule\CMSBundle\Entity\Classroom;
use Schedule\CMSBundle\Form\ClassroomType;
...
class ClassroomController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ScheduleCMSBundle:Classroom')->findAll();
     ...
     * @Method("POST")
     * @Template("ScheduleCMSBundle:Classroom:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ScheduleCMSBundle:Classroom')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ScheduleCMSBundle:Classroom:edit.html.twig")
     */
